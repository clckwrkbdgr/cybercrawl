...
if (you[0].haste == 0) mons [i].m_speed_inc += (mons [i].m_speed * time_taken / 10);
	else mons [i].m_speed_inc += (mons [i].m_speed * (time_taken / 2) / 10);

if (you[0].slow > 0) mons [i].m_speed_inc += (mons [i].m_speed * time_taken / 10);
...
{
 if (mons [i].m_class >= MLAVA0 && mons [i].m_sec == 1) break;
 if (mons [i].m_class == -1) break; // problem with vortices
	mons_in_cloud();
	if (mons [i].m_class == -1)
	{
...
case 2: if ((mons [i].m_targ_1_x == mons [i].m_x && mons [i].m_targ_1_y == mons [i].m_y) | random2(20) == 0)
{
...
if (mons [i].m_hp > (mons [i].m_hp_max / 2)) mons [i].m_beh = 1;
...
if (mons [i].m_hit == i | mons [mons [i].m_hit].m_beh == 7) mons [i].m_hit = MHITNOT;
...
if (mons [i].m_hit != MHITNOT && ((mons_near(i) == 1 && mons_near(mons [i].m_hit) == 1) | distance(mons [i].m_x, mons [mons [i].m_hit].m_x, mons [i].m_y, mons [mons [i].m_hit].m_y) == 1))
{
  ...
  mons [i].m_targ_1_y = mons [mons [i].m_hit].m_y;
    ...
    if (mons_near(i) == 1 && (mons [i].m_targ_1_x == mons [i].m_x && mons [i].m_targ_1_y == mons [i].m_y) | random2(6) == 0)
    {
     if (random2(7) == 0)
      {
        mons [i].m_targ_1_x = random2(80);
...
switch (mons [i].m_ench [p])
{
	...
	{
  if (mons [i].m_class == 66 | mons [i].m_class == 21 | mons [i].m_class == 141) continue; // butterfly, fire vortex
		mons [i].m_beh = 1;
		mons [i].m_ench [p] = 0;
		if (mons [i].m_ench [0] == 0 && mons [i].m_ench [1] == 0 && mons [i].m_ench [2] == 0)
		mons [i].m_ench_1 = 0;
	...
	{
  if (mons [i].m_class == 46 | mons [i].m_class == 141) continue;
  if (mons [i].m_class >= MLAVA0 && mons [i].m_sec == 1) continue; //grid [mons [i].m_x] [mons [i].m_y] == 61) continue;
		mons [i].m_ench [p] = 0;
		if (mons [i].m_ench [0] == 0 && mons [i].m_ench [1] == 0 && mons [i].m_ench [2] == 0)
		mons [i].m_ench_1 = 0;
	}
   ...
   if (random2(2) == 0) mons [i].m_hp -= random2((mons [i].m_ench [p] % 50) - 5) + 1;
   if (mons [i].m_hp <= 0)
   {
      if (mons [i].m_ench [p] < 50) killer = 1; // ie you
         else killer = 5;
      monster_die(i);
      goto endbat;
   }
   ...
   if (mons_res_fire(mons [i].m_class) == -1) mons [i].m_hp -= ((random2(5) + random2(5) + 1) * 10) / mons [i].m_speed;
   if (mons_near(i) == 1)
   {
   ...
   if (mons [i].m_hp <= 0)
   {
      if (mons [i].m_ench [p] < 60) killer = 1; // ie you
         else killer = 5;
      monster_die(i);
      goto endbat;
   }
...
if (mons [i].m_class == 25 | mons [i].m_class == 51 | mons [i].m_class == 107 | mons [i].m_class == 108) mons [i].m_hp_max = mons [i].m_hp;

if (mons [i].m_hp < mons [i].m_hp_max && (random2(25) == 0 | mons [i].m_class == 8 | mons [i].m_class == 45 | mons [i].m_class == 76 | mons [i].m_class == 135 | mons [i].m_class == 160 | mons [i].m_class == 234 | mons [i].m_class == 221 | mons [i].m_class == 227 | mons [i].m_class == 292)) mons [i].m_hp ++;
...
{
if (mons [i].m_targ_1_x < mons [i].m_x) mmov_x = 1; else mmov_x = 0;
if (mons [i].m_targ_1_x > mons [i].m_x) mmov_x = -1;
if (mons [i].m_targ_1_y < mons [i].m_y) mmov_y = 1; else mmov_y = 0;
if (mons [i].m_targ_1_y > mons [i].m_y) mmov_y = -1;
} else
      {
	if (mons [i].m_targ_1_x < mons [i].m_x) mmov_x = -1; else mmov_x = 0;
	if (mons [i].m_targ_1_x > mons [i].m_x) mmov_x = 1;
...
if (mgrid [mons [i].m_x + mmov_x] [mons [i].m_y + mmov_y] != MNG && mgrid [mons [i].m_x + mmov_x] [mons [i].m_y + mmov_y] != i)
{
 ...
 if (mons [i].m_beh == 7 && mons [mnt].m_beh != 7) mons [i].m_hit = mnt;
 if (mons [i].m_beh != 7 && mons [mnt].m_beh == 7) mons [i].m_hit = mnt;
}
...
if (random2(2) == 0 && (mons [i].m_ench [2] != 6 | you[0].see_invis != 0))
{
  ...
  ep_ch = 1;
  mons [i].m_hp += 5;
  if (mons [i].m_hp >= mons [i].m_hp_max) mons [i].m_hp = mons [i].m_hp_max;
}
break;
...
{
 if (random2(10) == 0 && (mons [i].m_x != you[0].x_pos | mons [i].m_y != you[0].y_pos)) mons [i].m_sec = 0;
}
break;
...
if ((mons [i].m_beh == 1 | mons [i].m_beh == 3) && mons_near(i) == 1) you[0].pet_target = i;
...
if (trac_targ == MHITYOU && mons_near(i) == 0 && mons [i].m_class != 234) goto end_switch; //continue;
...
case MLAVA2:
if (you[0].invis != 0 && mons_see_invis(mons [i].m_class) == 0) break;
if (random2(2) == 0 | mons [i].m_sec == 1 | mons [i].m_ench [2] == 6) break;
// viewwindow was here.
...
case MWATER2:
if (you[0].invis != 0 && mons_see_invis(mons [i].m_class) == 0) break;
if (mons [i].m_sec == 1 | mons [i].m_ench [2] == 6) break;
if (show [mons [i].m_x - you[0].x_pos + 6] [mons [i].m_y - you[0].y_pos + 6] != 0)
{
move_x = 0; move_y = 0;
move_x = trac_targ_x - mons [i].m_x;
...
if (random2(4) == 0) // fiend!
{
  ...
  tracer_f();
  if (mons [i].m_beh == 7 && tracer == 1) break;
...
if (mons [i].m_class == 80)
 switch(random2(3))
 {
 	case 0: mons [i].m_sec = RED; break;
 	case 1: mons [i].m_sec = LIGHTRED; break;
 	case 2: mons [i].m_sec = YELLOW; break;
 }

if (you[0].invis != 0 && mons_see_invis(mons [i].m_class) == 0) break;

if (random2(200) > 50 + mons[i].m_HD) break;

msecc = mons [i].m_sec;
if (mons [i].m_class == 80) msecc = 30; // burning devil
...
if (mons [i].m_beh == 7 && trac_hit_tamed == 1) break;
...
if (mons [i].m_beh != 3)
{
 ...
 {
  if (random2(2) == 0 | (mons [i].m_ench_1 == 1)) break;
 ...
 if ((tracer == 1 && (tracer_mons != 1)) | (trac_targ != MHITYOU))// && trac_hit_mons == 1)) //tracer_mons == 2 | tracer_mons == 3))
 {
	...
	{
  if (random2(3) == 0) break; // if (random2(5) != 0)
...
if (mons [i].m_class == 101 | mons [i].m_class == 122 | mons [i].m_class == 132 | mons [i].m_class == 146) // steam, mottled, storm and golden dragons
 {
  if (mons [i].m_ench [2] != 6)
			{
 ...
 if (mons [i].m_class == 79) // great orb of eyes
 {
  if (mons [i].m_ench [2] != 6)
			{
   		strcat(info, " gazes.");
 ...
 if (mons [i].m_class == 141) // vapour
 {
  mons [i].m_ench [2] = 6;
 }
 else
 if (mons [i].m_class == 70) // giant orange brain
 {
  if (mons [i].m_ench [2] != 6)
			{
 ...
 if (mons [i].m_class == 340)
 {
   strcat(info, " winds a great silver horn.");
   incrl();
 } else
 if ((mons [i].m_class >= 80 && mons [i].m_class <= 90) | mons [i].m_class == 68 | (mons [i].m_class >= 220 && mons [i].m_class <= 234))
	{
...
end_switch : if (gmon_use [mons [i].m_class] > 0 && mons [i].m_inv [1] != 501 && mons [i].m_class != 30 && (you[0].invis == 0 | mons_see_invis(mons [i].m_class) != 0)) // 2-h ogre
{
...
/*	brek = 0;
  ...
  tracer_f();
  if (mons [i].m_beh == 7 && tracer == 1 && tracer_mons != 1) goto end_throw;
...
//		{
			if (monsters_fight(i, mgrid [mons [i].m_x + mmov_x] [mons [i].m_y + mmov_y]) == 1)
   {
    if (mons [i].m_class == 1 | mons [i].m_class == 46) mons [i].m_speed_inc -= mons [i].m_speed;
		  mmov_x = 0; mmov_y = 0;
 			brkk = 1;
	 		break;
   }
...
if (mons [i].m_class == 1 | mons [i].m_class == 46 && bat == 0) monster_attack(i);
...
if (mons [i].m_class != 1 && mons [i].m_class != 46) monster_attack(i);
...
if (mons [i].m_class == -1 | mons [i].m_class == 61) continue;
                         // o plant
monster_move();
...
if (mons [i].m_hp <= (mons [i].m_hp_max / 4 - 1) && mons_intel(mons [i].m_class) > 1) mons [i].m_beh = 3;
...
if (mons [i].m_beh == 6 && random2(3) != 0) mons [i].m_beh = 1; // I think?
...
//	if (random2(3) == 0) return;
   ...
   if (quant_eated > it[0].iquant [igrid [mons [i].m_x] [mons [i].m_y]]) quant_eated = it[0].iquant [igrid [mons [i].m_x] [mons [i].m_y]];
...
//        hps_gained = random2(10) + 3;
   ...
   if (it[0].iquant [igrid [mons [i].m_x] [mons [i].m_y]] <= 0) igrid [mons [i].m_x] [mons [i].m_y] = it[0].ilink [igrid [mons [i].m_x] [mons [i].m_y]];


   mons [i].m_hp += hps_gained;
   if (mons [i].m_hp > mons [i].m_hp_max) mons [i].m_hp_max = mons [i].m_hp;
...
if (mons [i].m_hp >= 50)
{
         ...
         if (jelly_divide(i) == 0) mons [i].m_hp = 50; //abort();
...
switch(it[0].iclass [igrid [mons [i].m_x] [mons [i].m_y]])
{
	...
	if (mons [i].m_inv [0] != 501)
		return;
 if (it[0].idam [igrid [mons [i].m_x] [mons [i].m_y]] > 180) return; // too tricky for now
        if ((mons_charclass(mons [i].m_class) == 36 | mons_charclass(mons [i].m_class) == 6) && property [it[0].iclass [igrid [mons [i].m_x] [mons [i].m_y]]] [it[0].itype[igrid [mons [i].m_x] [mons [i].m_y]]] [1] <= 0) return; // wimpy monsters shouldn't pick up halberds etc
 ...
 if (it[0].idam [mons [i].m_inv [0]] % 30 == 7) mons [i].m_AC += 3;
	strcpy(info, monam (mons [i].m_sec, mons [i].m_class, mons [i].m_ench [2], 0));
 strcat(info, " picks up ");
 it_name(mons [i].m_inv [0], 3);
	strcat(info, str_pass);
 strcat(info, ".");
 if (mons_near(i)) incrl();
	mmov_x = 0; mmov_y = 0;
	break;
